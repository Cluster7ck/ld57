...
func circle_arc(center, radius := 10.0, angle_from := 0.0, angle_to := 90.0, pie := true,
		resolution := 16, color := Color(1, 0, 1), line_width := 1.0, duration := 0.0):
...
func circle_arc_filled(center, radius := 10.0, angle_from := 0.0, angle_to := 90.0, pie := true,
		resolution := 16, color := Color(1, 0, 1), duration := 0.0):
